            ...
            <div className="feedback-details-card">
                ...
                <div className="feedback-meta-grid">
                    ...
                    <div className="feedback-meta-item">
                        ...
                        <span style={{ textTransform: 'capitalize', color: interview.status === 'processing' ? 'var(--neon-blue)' : 'inherit' }}>
                ...
                {interview.status === 'processing' && (
                    <div style={{ padding: '40px', textAlign: 'center', background: 'rgba(0, 200, 255, 0.05)', borderRadius: '10px', margin: '20px 0' }}>
                        <InfinityLoader message="AI is analyzing your interview..." />
                        <p style={{ marginTop: '15px', color: '#666' }}>This usually takes 10-20 seconds. Results will appear here automatically.</p>
                    </div>
                )}
